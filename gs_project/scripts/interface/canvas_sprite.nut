...
{		
	...
	{		
		PictureTextRender(array_picture["canvas_part"], Rect(x_start, y_start, x_end, y_end), _text.tostring(), "simu_font" ,{ size = g_size_font_text, color = g_size_font_color_text })												
	}
	////////////////////////////////////////////////////////////////////////
